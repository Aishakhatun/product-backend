  ...
  try {
    ...
    if (count === 0) {
      ...
      await Product.insertMany([
        ...
        // 10 Accessories
        { name: 'Handmade Neem Wood Wide-Tooth Comb', slug: 'handmade-neem-wood-comb', category: accCat._id, description: 'Anti-static, anti-bacterial medicinal neem wood comb that gently detangles hair and prevents breakage.', isFeatured: true, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 80, price: 199, stock: 100 }] },
        { name: 'Mulberry Silk Hair Scrunchies Set (Pack of 3)', slug: 'mulberry-silk-hair-scrunchies', category: accCat._id, description: '100% Pure Mulberry Silk scrunchies designed to glide over hair without snagging, creasing, or tearing.', isFeatured: true, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 60, price: 399, stock: 80 }] },
        { name: 'Eco-Friendly Jute Tote Shopping Bag', slug: 'jute-tote-shopping-bag', category: accCat._id, description: 'Durable, biodegradable natural jute tote featuring reinforced cotton handles and spacious interior.', isFeatured: false, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 250, price: 299, stock: 50 }] },
        { name: 'Organic Cotton Headband & Hair Wrap', slug: 'organic-cotton-headband-wrap', category: accCat._id, description: 'Soft stretch organic cotton headband ideal for skincare routines, yoga, or everyday casual styling.', isFeatured: false, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 50, price: 249, stock: 65 }] },
        { name: 'Bamboo Fibre Scalp Massager & Shampoo Brush', slug: 'bamboo-scalp-massager-brush', category: accCat._id, description: 'Ergonomic eco-bamboo body with soft silicone bristles to stimulate microcirculation during shampooing.', isFeatured: true, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 90, price: 349, stock: 75 }] },
        { name: 'Hand-Drawn Velvet Cosmetic Pouch', slug: 'velvet-cosmetic-pouch', category: accCat._id, description: 'Plush velvet makeup travel pouch with gold metallic zipper and water-resistant inner lining.', isFeatured: false, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 120, price: 449, stock: 45 }] },
        { name: 'Natural Jade Roller & Gua Sha Facial Set', slug: 'natural-jade-roller-gua-sha', category: accCat._id, description: 'Authentic Xiuyan green jade stone roller and heart-shaped gua sha tool to boost collagen and lymphatic drainage.', isFeatured: true, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 180, price: 699, stock: 30 }] },
        { name: 'Handwoven Rattan Straw Beach Handbag', slug: 'rattan-straw-beach-handbag', category: accCat._id, description: 'Artisanal handwoven round rattan bag with genuine leather shoulder strap and linen lining.', isFeatured: true, isAvailable: true, images: ['/images/hero-banner.jpg'], variants: [{ grams: 350, price: 899, stock: 20 }] },
